...
<link rel="shortcut icon" type="image/x-icon"
	href="home_style/images/favicon.ico">
...
<!-- plugin: owl carousel  -->
<link href="home_style/plugins/owlcarousel/assets/owl.carousel.min.css"
	rel="stylesheet">
<link href="home_style/plugins/owlcarousel/assets/owl.theme.default.css"
	rel="stylesheet">
<script src="home_style/plugins/owlcarousel/owl.carousel.min.js"></script>
...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				<a class="navbar-brand" href="#"><img class="logo"
					src="home_style/images/logos/logo-alibaba.png"
					...
					<ul class="navbar-nav mr-auto">
						<li class="nav-item dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="#">Suppliers by
										Regions </a></li>
						...
						<li class="nav-item dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="#">Logistics Service
								</a></li>
								<li><a class="dropdown-item" href="#">Membership
										Services</a></li>
							</ul></li>
						<li class="nav-item dropdown"><a href="#"
							class="nav-link dropdown-toggle" data-toggle="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a class="dropdown-item" href="#">Submit a Dispute
								</a></li>
					...
					<ul class="navbar-nav">
						...
						<c:choose>
							<c:when test="${admin.nome != null}">
								<li class="nav-item"><a
									href="admin/starter-page-order.html" class="nav-link">
										Produtos </a></li>
										<li class="nav-item"><a
											...
											<c:choose>
												<c:when test="${cliente.nome != null}">
													<div class="text-wrap text-dark">
														Olá: <br> ${cliente.nome} <i class="fa fa-caret-down"></i>
													</div>
										</div>
									</a>
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="sign-up.html">Have account?
									...
									<form class="px-4 py-3" action="/login" method="post">
										<div class="form-group">
											<label>Email address</label> <input type="email"
												class="form-control" name="email" id="first-name"
												value="ken@streetfigher.com" placeholder="email@example.com">
										</div>
										<div class="form-group">
											<label>Password</label> <input type="password"
												class="form-control" value="123456789" name="senha"
	...
	<section class="section-main bg padding-y-sm">
		<div class="container">
					...
					<div class="row row-sm">
						<aside class="col-md-3">
							...
							<ul class="menu-category">
								...
								<c:forEach var="categorias1" items="${categorias1}">

									<li><a href="#">${categorias1.nome} </a></li>
								...
								<li class="has-submenu"><a href="#">More category <i
									...
									<ul class="submenu">
										<c:forEach var="categorias2" items="${categorias2}">

											<li><a href="#">${categorias2.nome} </a></li>
			...
			<figure class="mt-3 banner p-3 bg-secondary">
				<div class="text-lg text-center white">Useful banner can be
					here</div>
			</figure>
				...
				<div class="row no-gutters">
						...
						<article href="#" class="card-banner h-100 bg2">
							<div class="card-body zoom-wrap">
								...
								<p>Consectetur adipisicing elit, sed do eiusmod tempor
									...
									sit amet, cLorem ipsum dolor sit amet, cLorem ipsum dolor sit
									amet, cLorem ipsum dolor sit amet, c</p>
								<a href="#" class="btn btn-warning">Explore</a> <img
									src="home_style/images/items/item-sm.png" height="200"
					...
					<div class="col-md-9">
						<ul class="row no-gutters border-cols">
							<li class="col-6 col-md-3"><a href="#" class="itembox">
									<div class="card-body">
										<p class="word-limit">Home and kitchen electronic stuff
											collection</p>
										<img class="img-sm" src="home_style/images/items/1.jpg">
									</div>
							</a></li>
							<li class="col-6 col-md-3"><a href="#" class="itembox">
									<div class="card-body">
										<p class="word-limit">Kitchen equipments collection</p>
										<img class="img-sm" src="home_style/images/items/2.jpg">
									</div>
							</a></li>
							<li class="col-6 col-md-3"><a href="#" class="itembox">
									<div class="card-body">
										<p class="word-limit">Accessiries and other good items</p>
										<img class="img-sm" src="home_style/images/items/3.jpg">
									</div>
							</a></li>
							<li class="col-6 col-md-3"><a href="#" class="itembox">
									<div class="card-body">
										<p class="word-limit">Techs, Electronics</p>
										<img class="img-sm" src="home_style/images/items/4.jpg">
									</div>
							</a></li>
						</ul>
						<ul class="row no-gutters border-cols">
			...
			<div class="card">
				<div class="row no-gutters">
					<div class="col-md-3">
						...
						<article href="#" class="card-banner h-100 bg2">
							<div class="card-body zoom-wrap">
								<h5 class="title">Good equipments for cooking food and
									cakes</h5>
	...
	<section class="section-request bg padding-y-sm">
		<div class="container">
			<header class="section-heading heading-line">
				<h4 class="title-section bg text-uppercase">Request for
					Quotation</h4>
			</header>
				...
				<div class="col-md-8">
					<figure class="card-banner banner-size-lg">
						<figcaption class="overlay left">
							<br>
							<h2 style="max-width: 300px;">Big boundle or collection of
								featured items</h2>
							<br> <a class="btn btn-warning" href="#">Detail info Â»
							</a>
						</figcaption>
						<img src="home_style/images/banners/banner-request.jpg">
					</figure>
				</div>
				<!-- col // -->
				<div class="col-md-4">
						...
						<form>
							...
							<div class="form-group">
								<div class="input-group">
									<input class="form-control" name="" type="text"> <span
										class="input-group-btn" style="border: 0; width: 0;"></span> <select
										class="form-control">
			...
			<div class="row-sm">
				<div class="col-md-2">
					<figure class="card card-product">
						<div class="img-wrap">
							<img src="home_style/images/items/3.jpg">
						</div>
				...
				<div class="col-md-2">
					<figure class="card card-product">
						<div class="img-wrap">
							<img src="home_style/images/items/4.jpg">
						</div>
						<figcaption class="info-wrap">
							<h6 class="title ">
								<a href="#">The name of product</a>
							</h6>
							<div class="price-wrap">
				...
				<div class="col-md-2">
					<figure class="card card-product">
						<div class="img-wrap">
							<img src="home_style/images/items/5.jpg">
						</div>
						<figcaption class="info-wrap">
							<h6 class="title ">
				...
				<div class="col-md-2">
					<figure class="card card-product">
						<div class="img-wrap">
							<img src="home_style/images/items/6.jpg">
						</div>
						<figcaption class="info-wrap">
							<h6 class="title ">
								<a href="#">The name of product</a>
	...
	<section class="section-links bg padding-y-sm">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<header class="section-heading heading-line">
						<h4 class="title-section bg text-uppercase">Suppliers by
							Region</h4>
					</header>

					<ul class="list-icon row">
						<li class="col-md-4"><a href="#"><img
								src="home_style/images/icons/flag-usa.png"><span>United
									States</span></a></li>
						<li class="col-md-4"><a href="#"><img
								src="home_style/images/icons/flag-in.png"><span>India</span></a></li>
						<li class="col-md-4"><a href="#"><img
								src="home_style/images/icons/flag-tr.png"><span>Turkey</span></a></li>
						<li class="col-md-4"><a href="#"><img
								src="home_style/images/icons/flag-kr.png"><span>Korea</span></a></li>
						<li class="col-md-4"><a href="#"><img
								src="home_style/images/icons/flag-tr.png"><span>Turkey</span></a></li>
						<li class="col-md-4"><a href="#"><img
								src="home_style/images/icons/flag-kr.png"><span>Korea</span></a></li>
				...
				<div class="col-sm-6">
					...
					<ul class="list-icon row">
						<li class="col-md-4"><a href="#"><i
								class="icon fa fa-comment"></i><span>Trade Assistance</span></a></li>
						<li class="col-md-4"><a href="#"><i
								class="icon  fa fa-suitcase"></i><span>Business Identity</span></a></li>
						<li class="col-md-4"><a href="#"><i
								class="icon fa fa-globe"></i><span>Worldwide delivery</span></a></li>
						<li class="col-md-4"><a href="#"><i
								class="icon fa fa-phone-square"></i><span>Customer
									support</span></a></li>
						<li class="col-md-4"><a href="#"><i
								class="icon fa fa-globe"></i><span>Worldwide delivery</span></a></li>
						<li class="col-md-4"><a href="#"><i
			...
			<figure class="mt-3 banner p-3 bg-secondary">
				<div class="text-lg text-center white">Another banner can be
					here</div>
			</figure>
	...
	<section class="section-subscribe bg-secondary padding-y-lg">
		<div class="container">
			...
			<p class="pb-2 text-center white">Delivering the latest product
				trends and industry news straight to your inbox</p>
			...
			<div class="row justify-content-md-center">
				<div class="col-lg-4 col-sm-6">
					...
					<small class="form-text text-white-50">Weâll never share
						your email address with a third-party. </small>
				</div>
				<!-- col-md-6.// -->
			</div>
			...
			<section class="footer-bottom row border-top-white">
				...
				<div class="col-sm-6">
					<p class="text-md-right text-white-50">
						Copyright &copy <br> <a href="http://bootstrap-ecommerce.com"
							class="text-white-50">Bootstrap-ecommerce UI kit</a>
					</p>
				</div>
			</section>
			<!-- //footer-top -->
