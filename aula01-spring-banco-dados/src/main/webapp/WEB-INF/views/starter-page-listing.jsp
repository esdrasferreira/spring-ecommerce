...
<title>UI KIT - Marketplace and Ecommerce html template</title>
	...
	<link href="home_style/images/favicon.ico" rel="shortcut icon"
		  type="image/x-icon">
...
<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/"> Download <i class="fa fa-download"></i></a></li>
    </ul>
  </div>
</div> <!-- container //  -->
</nav>
 ...
 <article class="card card-product">
	...
	<div class="row">
		...
		<article class="col-sm-6">
				<h4 class="title"> ${produtos.nome}  </h4>
		...
		<aside class="col-sm-3 border-left">
			<div class="action-wrap">
				<div class="price-wrap h4">
					<span class="price"> ${produtos.valor} </span>
